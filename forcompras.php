...
<div id="muestratipoentrada"> <select name="codcategoria" id="codcategoria" class="form-control">
												<option value="">SELECCIONE</option>
			<?php
			$cat = new Login();
...
<input class="form-control" type="text" name="cantidad" id="cantidad" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Cantidad de Compra">
...
<input class="form-control number" type="text" name="preciocompra" id="preciocompra" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Precio de Compra"> 
...
<input class="form-control number" type="text" name="precioventa" id="precioventa" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Precio de Venta"> 
                        <i class="fa fa-dollar form-control-feedback"></i>
                              </div> 
                        </div>
...
<small>En caso de estar registrado el Producto o Ingrediente, por favor seleccione el tipo de entrada y luego realice la búsqueda del mismo para cargar los campos con los valores registrados en la Base de Datos</small>		
...
<div class="table-responsive" data-pattern="priority-columns">
           <table id="carrito" class="table table-small-font table-striped">
            <thead>
      <tr style="background:#FFCC66;font-size:16px;">
      <th style="color:#FFFFFF;"><div align="center">Cantidad</div></th>
      <th style="color:#FFFFFF;"><div align="center">Código</div></th>
      <th style="color:#FFFFFF;"><div align="center">Descripción de Producto</div></th>
      <th style="color:#FFFFFF;"><div align="center">Precio</div></th>
      <th style="color:#FFFFFF;"><div align="center">IGV</div></th>
      <th style="color:#FFFFFF;"><div align="center">Importe</div></th>
      <th style="color:#FFFFFF;"><div align="center">Acción</div></th>
      </tr>
          </thead>
...
<td width="150"><span class="Estilo10"><label id="lblsubtotal" name="lblsubtotal"><?php echo $simbolo; ?>0.00</label><input type="hidden" name="txtsubtotal" id="txtsubtotal" value="0.00"/></span></td>
                          

<td width="350"><span class="Estilo10"><label>Subtotal IGV 0%:</label></span></td>
<td width="150"><span class="Estilo10"><label id="lblsubtotal2" name="lblsubtotal2"><?php echo $simbolo; ?>0.00</label><input type="hidden" name="txtsubtotal2" id="txtsubtotal2" value="0.00"/></span></td>

 <td width="200"><span class="Estilo10"><center><label style="color:#000000;font-size:26px;">Total:</label></center></span></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
...
<td><span class="Estilo10"><label id="lbliva" name="lbliva"><?php echo $simbolo; ?>0.00</label><input type="hidden" name="txtIva" id="txtIva" value="0.00"/></span></td>
...
<td><span class="Estilo10"><label id="lbldescuento" name="lbldescuento"><?php echo $simbolo; ?>0.00</label><input type="hidden" name="txtDescuento" id="txtDescuento" value="0.00"/></span></td>

 <td><span class="Estilo10"><center><label style="color:#000000;font-size:22px;" id="lbltotal" name="lbltotal">0.00</label>

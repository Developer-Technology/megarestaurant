...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Clientes<span class="pull-right">
...
<li><a href="forcliente" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Cliente"><i class="fa fa-plus"></i> Nuevo</a></li>
...
?>
 ...
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Cliente" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerCliente('<?php echo base64_encode($reg[$i]["codcliente"]); ?>')"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Cliente" onClick="actualizar('forcliente?codcliente=<?php echo base64_encode($reg[$i]["codcliente"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Cliente" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codcliente=<?php echo base64_encode($reg[$i]["codcliente"]) ?>&tipo=<?php echo base64_encode("CLIENTES") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>

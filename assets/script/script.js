	 ...
	 $("#configuracion").validate({
      ...
      rules:
	  {
       ...
       messages:
	   {
			...
			cedresponsable:{ required: "Ingrese DPI de Responsable", digits: "Ingrese solo digitos para DPI" },
...
{ 
	 ...
	 $("#usuario").validate({
      rules:
	  {
       ...
       messages:
	   {
            cedula:{ required: "Ingrese DPI de Usuario", digits: "Ingrese solo digitos para DPI", minlength: "Ingrese 7 digitos como minimo" },
	...
	$("#error").html('<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> YA EXISTE UN USUARIO CON ESTE NUMERO DE DPI, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>');
...
{ 
	 ...
	 $("#clientes").validate({
      rules:
	  {
       ...
       messages:
	   {
            cedcliente:{ required: "Ingrese DPI de Cliente", digits: "Ingrese solo digitos para DPI"},
...
{ 
	 ...
	 $("#proveedores").validate({
      rules:
	  {
       ...
       messages:
	   {
            ritproveedor:{ required: "Ingrese N&deg; Tributario de Proveedor" },
...
{ 
	 ...
	 $("#ingredientes").validate({
      rules:
	  {
       ...
       messages:
	   {
			codingrediente: { required: "Ingrese C&oacute;digo de Ingrediente" },
	...
	$("#error").html('<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> YA EXISTE UN INGREDIENTE CON ESTE C&Oacute;DIGO, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>');
						...
						$("#nroingrediente").load("funciones.php?muestranroingrediente=si");
						$("#codigoingrediente").load("funciones.php?muestracodigoingrediente=si");
						setTimeout(function() { $("#error").html(""); }, 5000);		
						$("#btn-submit").html('<span class="fa fa-save"></span> Registrar');
     ...
     rules:
	  ...
	  function submitForm()
	   {		
			  ...
			  var nuevaFila ="<tr style='background:#FFCC66;color:#FFFFFF;'>"+"<td colspan=4><center><label>NO HAY PRODUCTOS AGREGADOS</label></center></td>"+"</tr>";
...
/* FUNCION JQUERY PARA CERRAR MESA EN VENTA */	 	 
 $('document').ready(function()
{ 
     /* validation*/ 
	 $("#cerrar").validate({
	  ...
	  function submitForm()
	   {		
	     ...
	     if (total==0.00) {
				...
				$("#producto").focus();
				$('#producto').css('border-color','#2b4049');
				alert('NO HA AGREGADO PRODUCTOS PARA CERRAR MESA, VERIFIQUE POR FAVOR');
	...
	$("#error").html('<center><div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> LOS CAMPOS NO PUEDEN IR VACIOS, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>');
					...
					$("#btn-cerrar").html('<span class="fa fa-save"></span> Confirmar Pedido');
	...
	$("#error").html('<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> POR FAVOR ASIGNE EL CLIENTE A ESTA VENTA DE CREDITO PARA PAGOS DEL MISMO !</div></center>');
					...
					$("#btn-cierramesa").html('<span class="fa fa-save"></span> Cerrar Mesa');
...
/*  FIN DE FUNCION PARA CERRAR MESA EN VENTA */

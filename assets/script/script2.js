...
$('.micheckboxss').on('click', function() {
...
$.ajax({
      ...
      url: "eliminar.php",
        ...
        //$("#pedidos").load("funciones.php?BuscaMesaReservas=si&codmesa="+codmesa);
...
/*$(document).ready(function() {
    ...
    $('#cargamesas').load('funciones.php?CargarMesas=si');//actualizas el div
   }, 1000 );
});*/
...
$("#muestradetallesventas").load("funciones.php?BuscarDetallesVentas=si&tipobusquedad="+tipobusquedad+'&codventa='+idventa+'&codcaja='+codcaja+'&fecha='+fecha);
                setTimeout(function() { $("#delete-ok").html(""); }, 5000);
                $('#'+parent).remove();
            }
        });

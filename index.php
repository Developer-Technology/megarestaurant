...
<form class="form-horizontal m-t-20" name="loginform" id="loginform" action="">
 ...
 <div class="form-group has-feedback">
                <label class="control-label">Usuario: <span class="symbol required"></span></label>
              <input type="text" class="form-control" placeholder="Ingrese su Usuario" name="usuario" id="usuario" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" required="" aria-required="true">
					...
					<div class="form-group has-feedback">
              <label class="control-label">Clave: <span class="symbol required"></span></label>
...
<div class="col-xs-12"> 
<button class="btn btn-block btn-lg btn-warning waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Haga clic aquí para iniciar sesión" name="btn-login" id="btn-login" type="submit"><span class="fa fa-sign-in"></span> Ingresar a Sistema</button>
</div>
</div>
<hr>

...
if(isset($_SESSION['acceso'])) { 
  if ($_SESSION['acceso'] == "administrador" || $_SESSION["acceso"]=="cajero" || $_SESSION["acceso"]=="cocinero" || $_SESSION["acceso"]=="mesero") {
...
<li class="has_sub"><a href="javascript:void(0);"><span>Reportes</span><i class="pull-right fa fa-angle-double-right"></i></a>
 ...
 <li class="has_sub"><a href="javascript:void(0);"><span>Reportes</span><i class="pull-right fa fa-angle-double-right"></i></a>
  <ul style="">
  <li><a href="creditoxcliente">Créditos por Clientes</a></li>
  <li><a href="creditoxfecha">Créditos por Fechas</a></li>
 </ul>
</li>
 </ul>
 </li>
...
<!----- INICIO DE MENU ----->
 <div id="sidebar-menu">
 <ul>
 <li> <a href="panel" class="waves-effect"><i class="fa fa-desktop"></i><span> Inicio </span></a></li>
...
<!----- FIN DE MENU ----->
 ...
 <div id="sidebar-menu">
 <ul>
 <li> <a href="mostrador" class="waves-effect"><i class="fa fa-desktop"></i><span> Mostrador </span></a></li>

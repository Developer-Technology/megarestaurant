...
<div id="nroingrediente"><input type="hidden" name="codprocesoing" id="codprocesoing" <?php if (isset($reg[0]['codingrediente'])) { ?> value="" <?php } else { ?>  value="<?php echo GenerateRandomString(); ?>" <?php } ?>></div>
	  
<div id="codigoingrediente"><input type="text" class="form-control" name="codingrediente" id="codingrediente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Código de Ingrediente" <?php if (isset($reg[0]['codingrediente'])) { ?> value="<?php echo $reg[0]['codingrediente']; ?>" readonly="readonly" <?php } else { ?>  value="<?php echo $reg = $tra->CodigoIngrediente(); ?>" <?php } ?> required="" aria-required="true"></div>

...
if (isset($_GET['BuscaUsuarioModal']) && isset($_GET['codigo'])) {
  ...
  <tr>
    <td><strong>Documento:</strong> <?php echo $reg[0]['cedula']; ?></td>
  </tr>
  <tr>
...
if (isset($_GET['BuscaSalasModal']) && isset($_GET['codsala'])) {
 ...
 <div id="div1"> <table id="datatable-responsive" class="table table-bordered dt-responsive" cellspacing="0" width="100%">
          <thead>
            <tr>
              <th>N&deg;</th>
...
if (isset($_GET['muestracodigoingrediente'])) {
    ...
    $tra = new Login();
    ?>
<input type="text" class="form-control" name="codingrediente" id="codingrediente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese C�digo de Ingrediente" <?php if (isset($reg[0]['codingrediente'])) {?> value="<?php echo $reg[0]['codingrediente']; ?>" readonly="readonly" <?php }?>  value="<?php echo $reg = $tra->CodigoIngrediente(); ?>" required="" aria-required="true">
...
if (isset($_GET['BuscaComprasModal']) && isset($_GET['codcompra'])) {
    ...
    ?>
                         ...
                         <address>
<abbr title="N&deg; de Compra"><strong>N&deg; DE COMPRA: </strong> <?php echo $co[0]["codcompra"]; ?></abbr><br>
<abbr title="N&deg; de Serie"><strong>N&deg; DE SERIE: </strong> <?php echo $co[0]["codseriec"]; ?></abbr><br>
...
if ($co[0]['fechavencecredito'] == '0000-00-00') {echo "0";} elseif ($co[0]['fechavencecredito'] >= date("Y-m-d")) {echo "0";} elseif ($co[0]['fechavencecredito'] < date("Y-m-d")) {echo Dias_Transcurridos(date("Y-m-d"), $co[0]['fechavencecredito']);}?><br />

<abbr title="Status de Compra"><strong>STATUS DE COMPRA:</strong></abbr> <?php
if ($co[0]['fechavencecredito'] == '0000-00-00') {echo "<span class='label label-success'>" . $co[0]["statuscompra"] . "</span>";} elseif ($co[0]['fechavencecredito'] >= date("Y-m-d")) {echo "<span class='label label-success'>" . $co[0]["statuscompra"] . "</span>";} elseif ($co[0]['fechavencecredito'] < date("Y-m-d")) {echo "<span class='label label-danger'>VENCIDA</span>";}?>
                                                  </address>
                                                </div>
                                            </div>
                                        </div>
...
if (isset($_GET['BuscaComprasPoveedor']) && isset($_GET['codproveedor'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Compras de Productos del Proveedor <?php echo $pro[0]['nomproveedor']; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaComprasFechas']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Compras por Fechas Desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
<span class="product-label ng-binding "><?php echo getSubString($favoritos[$i]['producto'], 16); ?></span>
  ...
  <?php if ($x == 4) {echo "<div class='clearfix'></div>";
                $x = 0;}
            $x++;}}
...
<input type="hidden" name="cantidad" id="cantidad" value="1" placeholder="Cantidad">
                ...
                <tbody>
                  <tr>
<td style="background:#FFCC66;color:#FFFFFF;font-size:12px;" colspan=4><center><label>NO HAY PRODUCTOS AGREGADOS</label></center></td>
                  </tr>
                </tbody>
              </table>
...
<div id="delete-detalle"></div>
    ...
    <div id="cargadetallesproductos"><table class="table table-small-font table-striped">
        <thead>
    <tr>
<th style="background:#FFCC66;color:#FFFFFF;font-size:14px;" colspan=4><center><label>PRODUCTOS AGREGADOS</label></center>
            </th>
          </tr>
        </thead>
        <tbody>
...
<img src="assets/images/nuevo.png" style="cursor:pointer;" width="20" height="20" title="Nuevo Cliente" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false">
...
<input class="form-control" type="text" name="mesero" id="mesero" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $_SESSION['nombres'] ?>" readonly="readonly">
...
<table class="table table-small-font table-striped">
        <thead>
    <tr>
<th style="background:#FFCC66;color:#FFFFFF;font-size:12px;" colspan=4><label><center>PRODUCTOS AGREGADOS</center></label>
            </th>
          </tr>
        </thead>
        <tbody>
...
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Ventas <?php if ($tipobusqueda == "1") {echo "del Cliente " . $reg[0]['nomcliente'];} else if ($tipobusqueda == "2") {echo "de Caja N&deg; " . $reg[0]['nrocaja'] . " : " . $reg[0]['nombrecaja'];} else {echo "de Fecha " . $fecha;}?> </h3></div>
<div class="panel-body">
    ...
    ?>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="pull-right">
                         <address>
<abbr title="N&deg; de Venta"><strong>N&deg; DE VENTA: </strong> <?php echo $ve[0]["idventa"]; ?></abbr><br>
...
<abbr title="Dias Vencidos de Cr&eacute;dito"><strong>DIAS VENCIDOS:</strong></abbr> <?php
if ($ve[0]['fechavencecredito'] == '0000-00-00') {echo "0";} elseif ($ve[0]['fechavencecredito'] >= date("Y-m-d")) {echo "0";} elseif ($ve[0]['fechavencecredito'] < date("Y-m-d")) {echo Dias_Transcurridos(date("Y-m-d"), $ve[0]['fechavencecredito']);}?><br />
...
if ($ve[0]['fechavencecredito'] == '0000-00-00') {echo "<span class='label label-success'>" . $ve[0]["statusventa"] . "</span>";} elseif ($ve[0]['fechavencecredito'] >= date("Y-m-d")) {echo "<span class='label label-success'>" . $ve[0]["statusventa"] . "</span>";} elseif ($ve[0]['fechavencecredito'] < date("Y-m-d")) {echo "<span class='label label-danger'>VENCIDA</span>";}?>
                                                  </address>
                                                </div>
                                            </div>
                                        </div>
...
if (isset($_GET['BuscarDetallesVentas']) && isset($_GET['tipobusquedad']) && isset($_GET['codventa']) && isset($_GET['codcaja']) && isset($_GET['fecha'])) {
    ...
    if ($tipobusquedad == "") {
        ...
        echo "<center><div class='alert alert-danger'>";
        echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
        echo "<span class='fa fa-info-circle'></span> POR FAVOR INGRESE N&deg; DE FACTURA PARA TU B&Uacute;SQUEDA</div></center>";
        exit;
...
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Detalles de Ventas <?php if ($tipobusquedad == "1") {echo "de Factura N&deg; " . $reg[0]['idventa'];} else if ($tipobusquedad == "2") {echo "de Caja N&deg; " . $reg[0]['nrocaja'] . " : " . $reg[0]['nombrecaja'];} else {echo "de Fecha " . $fecha;}?> </h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaVentasFechas']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Ventas por Fechas Desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaProductosVendidosFechas']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Productos Vendidos desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaIngredientesVendidosFechas']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Ingredientes Vendidos desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaArqueosFechas']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Arqueos de Cajas desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaMovimientosFechas']) && isset($_GET['codcaja']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Movimientos de <?php echo $reg[0]['nombrecaja']; ?> desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaInformeVentasFechas']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Informe de Ventas desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaInformeCajasFechas']) && isset($_GET['codcaja']) && isset($_GET['desde']) && isset($_GET['hasta'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Informe de <?php echo $reg[0]['nombrecaja']; ?> desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
if (isset($_GET['BuscaAbonosClientes']) && isset($_GET['codcliente'])) {
  ...
  <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Creditos de Ventas del Cliente <?php echo $bon[0]['nomcliente']; ?></h3></div>
<div class="panel-body">
...
$a = 1;
        ...
        for ($i = 0; $i < sizeof($bon); $i++) {
            ...
            ?>
                           ...
                           <td><?php
if ($bon[$i]['fechavencecredito'] == '0000-00-00') {echo "<span class='label label-success'>" . $bon[$i]["statusventa"] . "</span>";} elseif ($bon[$i]['fechavencecredito'] >= date("Y-m-d")) {echo "<span class='label label-success'>" . $bon[$i]["statusventa"] . "</span>";} elseif ($bon[$i]['fechavencecredito'] < date("Y-m-d")) {echo "<span class='label label-danger'>VENCIDA</span>";}?></td>
                          <td><?php
if ($bon[$i]['fechavencecredito'] == '0000-00-00') {echo "0";} elseif ($bon[$i]['fechavencecredito'] >= date("Y-m-d")) {echo "0";} elseif ($bon[$i]['fechavencecredito'] < date("Y-m-d")) {echo Dias_Transcurridos(date("Y-m-d"), $bon[$i]['fechavencecredito']);}?></td>
                           <td>
...
if (isset($_GET['MuestraFormularioAbonos']) && isset($_GET['cedcliente']) && isset($_GET['codventa'])) {
 ...
 <div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gesti&oacute;n de Pagos a Cr&eacute;ditos de Factura N&deg; <?php echo base64_decode($codventa); ?></h3></div>
<div class="panel-body">
...
if ($ve[0]['fechavencecredito'] == '0000-00-00') {echo "0";} elseif ($ve[0]['fechavencecredito'] >= date("Y-m-d")) {echo "0";} elseif ($ve[0]['fechavencecredito'] < date("Y-m-d")) {echo Dias_Transcurridos(date("Y-m-d"), $ve[0]['fechavencecredito']);}?><br />
        <abbr title="Fecha de Venta"><strong>FECHA DE VENTA:</strong></abbr> <?php echo date("d-m-Y h:i:s", strtotime($ve[0]['fechaventa'])); ?><br />
        <abbr title="Status de Venta"><strong>STATUS DE VENTA:</strong></abbr> <?php
if ($ve[0]['fechavencecredito'] == '0000-00-00') {echo "<span class='label label-success'>" . $ve[0]["statusventa"] . "</span>";} elseif ($ve[0]['fechavencecredito'] >= date("Y-m-d")) {echo "<span class='label label-success'>" . $ve[0]["statusventa"] . "</span>";} elseif ($ve[0]['fechavencecredito'] < date("Y-m-d")) {echo "<span class='label label-danger'>VENCIDA</span>";}?><br />
...
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Creditos por Fechas Desde <?php echo $_GET["desde"] . " hasta " . $_GET["hasta"]; ?></h3></div>
<div class="panel-body">

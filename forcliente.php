...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Clientes</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="clientes">Control</a></li>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Clientes</h3></div>
...
<form class="form" name="updateclientes" id="updateclientes" method="post" data-id="<?php echo $reg[0]["codcliente"] ?>" action="#">
				
		<?php } else { ?>
				
		<form class="form" method="post"  action="#" name="clientes" id="clientes">	
  ...
  <input type="hidden" name="codcliente" id="codcliente" <?php if (isset($reg[0]['codcliente'])) { ?> value="<?php echo $reg[0]['codcliente']; ?>"<?php } ?>>
	  <input type="text" class="form-control" name="cedcliente" id="cedcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Documento de Cliente" <?php if (isset($reg[0]['cedcliente'])) { ?> value="<?php echo $reg[0]['cedcliente']; ?>"<?php } ?> required="" aria-required="true">
  ...
  <input type="text" class="form-control" name="nomcliente" id="nomcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Cliente" <?php if (isset($reg[0]['nomcliente'])) { ?> value="<?php echo $reg[0]['nomcliente']; ?>"<?php } ?> required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>  
                              </div> 
                        </div> 	
                    </div>
...
<textarea name="direccliente" class="form-control" id="direccliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Dirección de Cliente" required="" aria-required="true"><?php if (isset($reg[0]['direccliente'])) { ?><?php echo $reg[0]['direccliente']; ?><?php } ?></textarea>
    ...
    <input type="text" class="form-control" name="tlfcliente" id="tlfcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Telefono de Cliente" <?php if (isset($reg[0]['tlfcliente'])) { ?> value="<?php echo $reg[0]['tlfcliente']; ?>"<?php } ?>>
  ...
  <input type="text" class="form-control" name="emailcliente" id="emailcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Correo de Cliente" <?php if (isset($reg[0]['emailcliente'])) { ?> value="<?php echo $reg[0]['emailcliente']; ?>"<?php } ?>>

...
<div class="col-sm-12 col-xs-12">
       ...
       <form name="updatepassword" id="updatepassword" method="post" data-id="<?php echo $_SESSION["codigo"]?>" action="#">
				...
				<div class="row"> 
                  ...
                  <label class="control-label">DPI de Usuario: <span class="symbol required"></span></label> 
...
<input name="usuario" class="form-control" type="text" id="usuario" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Usuario de Acceso" autocomplete="off" value="<?php echo $_SESSION['usuario']; ?>" readonly="readonly"/>
   ...
   <input name="password" class="form-control" type="text" id="password" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nuevo Password de Acceso" autocomplete="off" required="required"/>
   ...
   <input name="password2" class="form-control" type="text" id="password2" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Repita Nuevo Password de Acceso" autocomplete="off" required="required"/>
                        <i class="fa fa-unlock form-control-feedback"></i>   
                                                                </div> 
                                                            </div> 	
                    </div>

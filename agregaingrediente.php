...
<div class="row"> 
	                ...
	                <hr>														
<div align="left"><button type="button" onClick="addRowX()" class="btn btn-primary waves-light"><span class="fa fa-plus"></span> Ingred.</button> 
<button type="button" onClick="borrar()" class="btn btn-danger waves-light" ><i class="fa fa-minus"></i> Ingred.</button> </div>
			        <hr>

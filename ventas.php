...
<select name="tipobusqueda" id="tipobusqueda" class="form-control" tabindex="1" required="" aria-required="true">
                        ...
                        <div class="col-md-4"> 
       <div class="form-group has-feedback"> 
      <label class="control-label">Ingrese Criterio de Clientes: <span class="symbol required"></span></label>
<input type="hidden" name="codcliente" id="codcliente">
<input class="form-control" type="text" name="busquedacliente" id="busquedacliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Documento o Nombre para Búsqueda de Clientes" required="required">

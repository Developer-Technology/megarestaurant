...
<div class="table-responsive" data-pattern="priority-columns">
             <table id="datatable-responsive" class="table table-small-font table-bordered table-striped">
                  <thead>
				  <tr role="row">
				  <th colspan="3" data-priority="1"><center>Agregar Ingredientes</center></th>
				  </tr>
                  </thead>
                  <tbody>
                    <tr>
<td data-priority="3"> <div class="form-group has-feedback"><input type="hidden" name="codingrediente[]" id="codingrediente"><input type="text" class="form-control" name="busqueda[]" id="busqueda" onKeyUp="this.value=this.value.toUpperCase(); autocompletar(this.name);" autocomplete="off" placeholder="Porción de Ingrediente"><i class="fa fa-pencil form-control-feedback"></i></div></td>

<td data-priority="2"> <div class="form-group has-feedback"><input type="text" class="form-control" name="cantidad[]" id="cantidad1" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Cantidad Porción"><i class="fa fa-pencil form-control-feedback"></i></div></td>

<td data-priority="3"> <div class="form-group has-feedback"><input type="text" class="form-control" name="unidadingrediente[]" id="unidadingrediente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Medida" readonly="readonly"><i class="fa fa-pencil form-control-feedback"></i></div></td>
...
myNewCell=myNewRow.insertCell(-1);
myNewCell.innerHTML='<div class="form-group has-feedback"><input type="text" class="form-control" name="unidadingrediente[]'+cont+'" id="unidadingrediente'+cont+'" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Medida" readonly="readonly"><i class="fa fa-pencil form-control-feedback"></i></div>';
indiceFila++;
}

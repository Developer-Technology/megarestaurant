...
########################## FUNCION PARA MOSTRAR EL FOOTER ############################
  ...
  $this->Cell(195,-4,'TELÉFONO: '.$con[0]['tlfempresa'],'0',0,'L');
  $this->Ln();
  $this->Cell(195,-3,'DIRECCIÓN: '.utf8_decode($con[0]['direcempresa']),'0',0,'L');
  $this->Ln();
...
########################## FUNCION LISTAR USUARIOS ##############################
      function TablaListarUsuarios()
   {
    ...
    $this->Cell(15,5,'',0,0,'');
    $this->CellFitSpace(42,5,'CÉDULA RESPONSABLE :',0,0,'');
...
############################# FUNCION LISTAR MOVIMIENTO DE INGREDIENTE ##########################
      function TablaKardexIngredientes()
   {
    ...
    //Movernos a la derecha
    $this->Cell(130);
    $this->Cell(180,8,'MOVIMIENTO DEL INGREDIENTE',0,0,'C');
    $this->Ln();
    //Movernos a la derecha
    $this->Cell(130);
...
$this->CellFitSpace(40,5,utf8_decode($simbolo.number_format($reg[$i]['preciom']*$reg[$i]['devolucion'], 2, '.', ',')),1,0,'C');*/
   ...
   $this->SetFont('courier','B',9);
    ...
    $this->Cell(45,5,'CÓDIGO',1,0,'C', True);
    $this->SetFont('courier','B',8);
    ...
    $this->SetFont('courier','B',9);
    $this->SetTextColor(255,255,255);  // Establece el color del texto (en este caso es blanco)
    $this->Cell(45,5,'DESCRIPCIÓN',1,0,'C', True);
    $this->SetFont('courier','B',8);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    ...
    /*$this->SetFont('courier','B',9);
    $this->SetTextColor(255,255,255);  // Establece el color del texto (en este caso es blanco)
    $this->Cell(45,5,'DEVOLUCIÓN',1,0,'C', True);
    $this->SetFont('courier','B',8);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
...
############################# FUNCION LISTAR MOVIMIENTO DE PRODUCTO ##########################
      function TablaKardexProductos()
   {
    ...
    //Movernos a la derecha
    $this->Cell(130);
    $this->Cell(180,8,'MOVIMIENTO DEL PRODUCTO',0,0,'C');
    $this->Ln();
    //Movernos a la derecha
    $this->Cell(130);
...
######################### FUNCION LISTAR COMPRAS POR PROVEEDORES ################################
   ...
   {         
    ...
    $this->CellFitSpace(30,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['subtotalivasic'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(30,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['subtotalivanoc'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(20,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['ivac'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(25,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totalivac'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(20,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['descuentoc'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(25,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totaldescuentoc'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(35,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totalc'], 2, '.', ',')),1,0,'C');
    $this->Ln();
    ...
    $this->Cell(30,5,utf8_decode($con[0]['simbolo'].number_format($Subtotalconiva, 2, '.', ',')),1,0,'C');
    $this->Cell(30,5,utf8_decode($con[0]['simbolo'].number_format($Subtotalsiniva, 2, '.', ',')),1,0,'C');
    $this->Cell(20,5,"",1,0,'C');
    $this->Cell(25,5,utf8_decode($con[0]['simbolo'].number_format($Totaliva, 2, '.', ',')),1,0,'C');
    $this->Cell(20,5,"",1,0,'C');
    $this->Cell(25,5,utf8_decode($con[0]['simbolo'].number_format($Totaldescuento, 2, '.', ',')),1,0,'C');
    $this->Cell(35,5,utf8_decode($con[0]['simbolo'].number_format($Pagototal, 2, '.', ',')),1,0,'C');
    $this->Ln();
...
########################## FUNCION LISTAR COMPRAS POR PROVEEDORES #################################
   ...
   {         
    ...
    //Logo
    $this->Image("./assets/images/logo_white_2.png" , 35 ,12, 80 , 25 , "PNG");  
    //Arial bold 15
    ...
    $this->Ln();
    $this->Cell(130);
    $this->Cell(180,10,'DESDE '.$_GET["desde"].' HASTA '.$_GET["hasta"],0,0,'C');
    $this->Ln(20);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(10,5,$a++,1,0,'C');
    $this->CellFitSpace(25,5,$reg[$i]["codcompra"],1,0,'C');
    $this->CellFitSpace(60,5,$reg[$i]["nomproveedor"],1,0,'C');
    
    if($reg[$i]['fechavencecredito']== '0000-00-00') { 
    $this->CellFitSpace(20, 5,utf8_decode($reg[$i]['statuscompra']),1,0,'C');
    } elseif($reg[$i]['fechavencecredito'] >= date("Y-m-d")) { 
    $this->CellFitSpace(20, 5,utf8_decode($reg[$i]['statuscompra']),1,0,'C');
    } elseif($reg[$i]['fechavencecredito'] < date("Y-m-d")) { 
    ...
    $this->CellFitSpace(20,5,utf8_decode($reg[$i]["articulos"]),1,0,'C');
    $this->CellFitSpace(25,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['subtotalivasic'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(25,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['subtotalivanoc'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(15,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['ivac'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(25,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totalivac'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(15,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['descuentoc'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(25,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totaldescuentoc'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(35,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totalc'], 2, '.', ',')),1,0,'C');
    $this->Ln();
    ...
    $this->Cell(25,5,utf8_decode($con[0]['simbolo'].number_format($Subtotalconiva, 2, '.', ',')),1,0,'C');
    $this->Cell(25,5,utf8_decode($con[0]['simbolo'].number_format($Subtotalsiniva, 2, '.', ',')),1,0,'C');
...
$this->SetXY(3, 34);
$this->Cell(3, 5, "FECHA IMPRESIÓN: ".date("d-m-Y h:i:s A ",time()+1800), 0 , 0);
...
$this->SetFont('courier','B',6.5);
$this->SetX(3);
$this->Cell(3, 3,"NIT CLIENTE: ".utf8_decode($ve[0]['cedcliente']),0,1);
$this->SetX(3);
...
########################## FUNCION LISTAR VENTAS GENERALES ######################################
   ...
   {    
    ...
    $this->SetFillColor(230, 126, 34); // establece el color del fondo de la celda (en este caso es NARANJA)
    $this->CellFitSpace(10,8,'N°',1,0,'C', True);
    $this->CellFitSpace(27,8,'CÓDIGO VENTA',1,0,'C', True);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(10,5,$a++,1,0,'C');
    $this->CellFitSpace(27,5,$reg[$i]["idventa"],1,0,'C');
    $this->Cell(20,5,utf8_decode($caja = ( $reg[$i]['codcaja'] == '0' ? "SIN COBRAR" : $reg[$i]["nrocaja"])),1,0,'C');
    $this->Cell(60,5,utf8_decode($cliente = ( $reg[$i]['codcliente'] == '0' ? "SIN ASIGNACION" : $reg[$i]["nomcliente"])),1,0,'C');
...
######################### FUNCION LISTAR VENTAS POR FECHAS Y CAJAS DE VENTAS #########################
      function TablaVentasCajas()
   {
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(10,5,$a++,1,0,'C');
    $this->CellFitSpace(32,5,$reg[$i]["idventa"],1,0,'C');
    $this->Cell(70,5,utf8_decode($cliente = ( $reg[$i]['codcliente'] == '0' ? "SIN ASIGNACION" : $reg[$i]["nomcliente"])),1,0,'C');
    ...
    $this->CellFitSpace(35,5,utf8_decode(date("d-m-Y h:i:s",strtotime($reg[$i]['fechaventa']))),1,0,'C');
    $this->CellFitSpace(15,5,utf8_decode($reg[$i]["articulos"]),1,0,'C');
    $this->CellFitSpace(28,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['subtotalivasive'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(28,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['subtotalivanove'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(12,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['ivave'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(22,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totalivave'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(12,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['descuentove'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(20,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totaldescuentove'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(30,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totalpago'], 2, '.', ',')),1,0,'C');
    $this->Ln();
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->Cell(15,5,utf8_decode($totalarticulos),1,0,'C');
    $this->Cell(28,5,utf8_decode($con[0]['simbolo'].number_format($Subtotalconiva, 2, '.', ',')),1,0,'C');
    $this->Cell(28,5,utf8_decode($con[0]['simbolo'].number_format($Subtotalsiniva, 2, '.', ',')),1,0,'C');
    $this->Cell(12,5,"",1,0,'C');
    $this->Cell(22,5,utf8_decode($con[0]['simbolo'].number_format($Totaliva, 2, '.', ',')),1,0,'C');
    $this->Cell(12,5,"",1,0,'C');
    $this->Cell(20,5,utf8_decode($con[0]['simbolo'].number_format($Totaldescuento, 2, '.', ',')),1,0,'C');
    $this->Cell(30,5,utf8_decode($con[0]['simbolo'].number_format($Pagototal, 2, '.', ',')),1,0,'C');
    $this->Ln();
...
################################### FUNCION LISTAR VENTAS POR FECHAS ######################################
      function TablaVentasFechas()
   {
    ...
    $this->CellFitSpace(27,5,$reg[$i]["idventa"],1,0,'C');
    $this->Cell(20,5,utf8_decode($caja = ( $reg[$i]['codcaja'] == '0' ? "SIN COBRAR" : $reg[$i]["nrocaja"])),1,0,'C');
    $this->Cell(60,5,utf8_decode($cliente = ( $reg[$i]['codcliente'] == '0' ? "SIN ASIGNACIÓN" : $reg[$i]["nomcliente"])),1,0,'C');
    ...
    $this->CellFitSpace(12,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['descuentove'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(20,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totaldescuentove'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(27,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['totalpago'], 2, '.', ',')),1,0,'C');
    $this->Ln();
    ...
    $this->Cell(12,5,"",1,0,'C');
    $this->Cell(20,5,utf8_decode($con[0]['simbolo'].number_format($Totaldescuento, 2, '.', ',')),1,0,'C');
    $this->Cell(27,5,utf8_decode($con[0]['simbolo'].number_format($Pagototal, 2, '.', ',')),1,0,'C');
    $this->Ln();
...
################################# FUNCION LISTAR ARQUEOS DE CAJAS #####################################
      function TablaListarArqueosCajas()
   {
    ...
    $this->Cell(100);
     //Título
    $this->Cell(65,15,'LISTADO DE ARQUEOS DE CAJAS',0,0,'C');
    $this->Ln();
    $this->Cell(100);
    $this->Cell(65,5,'DESDE '.$_GET["desde"].' HASTA '.$_GET["hasta"],0,0,'C');
    $this->Ln(10);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(10,5,$a++,1,0,'C');
    $this->CellFitSpace(32,5,$reg[$i]["nombrecaja"],1,0,'C');
    $this->CellFitSpace(40,5,utf8_decode($reg[$i]["fechaapertura"]),1,0,'C');
    $this->CellFitSpace(40,5,utf8_decode($reg[$i]["fechacierre"]),1,0,'C');
    $this->CellFitSpace(23,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['montoinicial']+$reg[$i]['ingresos']-$reg[$i]['egresos'], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(23,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]["dineroefectivo"], 2, '.', ',')),1,0,'C');
    $this->CellFitSpace(23,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]["diferencia"], 2, '.', ',')),1,0,'C');
    $this->Ln();
}
...
############################ FUNCION LISTAR MOVIMIENTOS DE CAJAS ################################
   ...
   //Logo
    ...
    $this->Cell(100);
     //Título
    $this->Cell(65,15,'LISTADO DE MOVIMIENTOS DE CAJAS ',0,0,'C');
    $this->Ln();
    $this->Cell(100);
    $this->Cell(65,5,'DESDE '.$_GET["desde"].' HASTA '.$_GET["hasta"],0,0,'C');
    $this->Ln(10);
...
$TotalEgresos+=$egresos = ( $reg[$i]['tipomovimientocaja'] == 'EGRESO' ? $reg[$i]['montomovimientocaja'] : "0"); 
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(10,5,$a++,1,0,'C');
    $this->CellFitSpace(35,5,$reg[$i]["fechamovimientocaja"],1,0,'C');
    $this->CellFitSpace(30,5,utf8_decode($reg[$i]["tipomovimientocaja"]),1,0,'C');
    $this->CellFitSpace(90,5,utf8_decode($reg[$i]["descripcionmovimientocaja"]),1,0,'C');
    $this->CellFitSpace(25,5,utf8_decode($con[0]['simbolo'].number_format($reg[$i]['montomovimientocaja'], 2, '.', ',')),1,0,'C');
    $this->Ln();
      }
...
########################### FUNCION LISTAR INFORMES DE VENTAS #####################################
   ...
   //Logo
    ...
    $this->Cell(100);
     //Título
    $this->Cell(65,15,'INFORME GENERAL DE VENTAS ',0,0,'C');
    $this->Ln();
    $this->Cell(100);
    $this->Cell(65,5,'DESDE '.$_GET["desde"].' HASTA '.$_GET["hasta"],0,0,'C');
    $this->Ln(10);
...
$reg = $reg->CajerosPorId();
   ...
   //Logo
    ...
    $this->Cell(100);
     //Título
    $this->Cell(65,15,'INFORME DE '.$reg[0]['nombrecaja'],0,0,'C');
    $this->Ln();
    $this->Cell(100);
    $this->Cell(65,5,'DESDE '.$_GET["desde"].' HASTA '.$_GET["hasta"],0,0,'C');
    $this->Ln(10);
...
################################# FUNCION LISTAR CREDITOS POR FECHAS #################################
   ...
   if($reg[$i]['nomcliente']== '') {
    ...
    $this->CellFitSpace(25,5,$con[0]['simbolo'].number_format($reg[$i]['totalpago'], 2, '.', ','),1,0,'C');
    $this->CellFitSpace(20,5,$con[0]['simbolo'].number_format($reg[$i]['abonototal'], 2, '.', ','),1,0,'C');
    $this->CellFitSpace(20,5,$con[0]['simbolo'].number_format($reg[$i]['totalpago']-$reg[$i]['abonototal'], 2, '.', ','),1,0,'C');
    $this->Ln();
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->Cell(25,5,utf8_decode($con[0]['simbolo'].number_format($TotalFactura, 2, '.', ',')),1,0,'C');
    $this->Cell(20,5,utf8_decode($con[0]['simbolo'].number_format($TotalCredito, 2, '.', ',')),1,0,'C');
    $this->Cell(20,5,utf8_decode($con[0]['simbolo'].number_format($TotalDebe, 2, '.', ',')),1,0,'C');
    $this->Ln();

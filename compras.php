...
<td><?php if($reg[$i]['fechavencecredito']== '0000-00-00') { echo "<span class='label label-success'><i class='fa fa-check'></i> ".$reg[$i]["statuscompra"]."</span>"; } elseif($reg[$i]['fechavencecredito'] >= date("Y-m-d")) { echo "<span class='label label-success'><i class='fa fa-times'></i> ".$reg[$i]["statuscompra"]."</span>"; } elseif($reg[$i]['fechavencecredito'] < date("Y-m-d")) { echo "<span class='label label-danger'><i class='fa fa-times'></i> VENCIDA</span>"; } ?></td>
											   <td>
...
<?php if($reg[$i]['statuscompra']=="PENDIENTE") { ?><a href="#" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Pagar Factura" onClick="pagar('eliminar?<?php echo base64_encode('eliminar'); ?>&codcompra=<?php echo base64_encode($reg[$i]["codcompra"]) ?>&tipo=<?php echo base64_encode("PAGARFACTURA") ?>')"><i class="fa fa-money"></i></a><?php } ?>
